...
스켈레톤이 본문을 비워 둔 자리에는 스펙의 "Comments — top down, in the reader's
language" 절대로 주석을 달아줘 — 이 모듈이 무엇을 위한 것이고 무엇이 그것을
성립시키는지 머리말로 먼저, 그 다음 블록마다 **왜** 한 줄. 핸드아웃이 원래 달아 둔
주석은 한 글자도 건드리지 말고, 네 주석은 그 주위에 써.
